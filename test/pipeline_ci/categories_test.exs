defmodule PipelineCi.CategoriesTest do
  use PipelineCi.DataCase

  alias PipelineCi.Categories

  describe "categories" do
    alias PipelineCi.Categories.Category

    import PipelineCi.CategoriesFixtures
